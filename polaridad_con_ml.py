...
# este tiene un agregado mas 
# el que hay que superar es el macro avg del f1-score
# hay que probar con el training, la forma de hacerlo es con validacion cruzada
# checa la table de emojis, las ultimas dos columnas son buenas para probar 
...
print ('Realizando validación cruzada...') # <------------------------------------------------------------------------- esto es interesante
# o tambien puedes usar k fold ????
# el parametro de scoring es importante para poder mejorarlo
